# Smoke Test — Langflow Memory Chatbot

## Test 1: JSON/YAML válido
```bash
python3 -c "import json; json.load(open('src/workflow.json' if 'n8n' in 'langflow/chatbots/langflow-chatbot-memory-chatbot' else 'src/flow.json')); print('JSON OK')"
