# Smoke Test — Langflow Vector Store RAG

## Test 1: JSON/YAML válido
```bash
python3 -c "import json; json.load(open('src/workflow.json' if 'n8n' in 'langflow/chatbots/langflow-chatbot-vector-store-rag' else 'src/flow.json')); print('JSON OK')"
