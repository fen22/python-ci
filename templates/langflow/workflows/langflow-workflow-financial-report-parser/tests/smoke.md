# Smoke Test — Langflow Financial Report Parser

## Test 1: JSON/YAML válido
```bash
python3 -c "import json; json.load(open('src/workflow.json' if 'n8n' in 'langflow/workflows/langflow-workflow-financial-report-parser' else 'src/flow.json')); print('JSON OK')"
