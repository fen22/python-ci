# Smoke Test — PDF Q&A with Citations

## Test 1: JSON/YAML válido
```bash
python3 -c "import json; json.load(open('src/workflow.json' if 'n8n' in 'n8n/workflows/n8n-workflow-pdf-qa' else 'src/flow.json')); print('JSON OK')"
