# Smoke Test — YouTube Summarizer

## Test 1: JSON/YAML válido
```bash
python3 -c "import json; json.load(open('src/workflow.json' if 'n8n' in 'n8n/workflows/n8n-workflow-youtube-summarizer' else 'src/flow.json')); print('JSON OK')"
